...
- `--io.save-dir`: Directory where the generated plot image and CSV will be saved (default: `./skewt_point`).
...
*The generated plot is saved as a PNG image in `./skewt_point/` (e.g. `./skewt_point/hrrr_skewt_38p360_-105p733_20260327_1600_lower_spot.png`). An accompanying spreadsheet containing the inversion layers and mixing height (including Above Ground Level delta AGL) is saved to `./skewt_point/hrrr_skewt_38p360_-105p733_20260327_1600_lower_spot_rx_params.csv`.*
