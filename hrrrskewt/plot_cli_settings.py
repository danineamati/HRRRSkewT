...
class LimitsSettings:
    ...
    """Preset selection: 'standard', 'lower' (boundary layer focus), or 'full' (stratosphere focus)."""
...
class IOSettings:
    ...
    """Whether to automatically append the limits preset name (e.g. '_lower', '_full') as a suffix."""
